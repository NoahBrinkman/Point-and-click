...
void setup()
{
  ...
  MultiPartScrollingTextObject nightStandInteraction = new MultiPartScrollingTextObject("*On top of your nightstand you see a photo of two people* ", width / 2 - 250, height -110, "", 15, color(0), 550, 450, "zoom.png", 50, 50, 0.01f);
